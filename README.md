...
| Acceptance | CR-025 Local MVP 的 AC-001/002/015/016 与 0.1.0 的历史 UAT 已 `ACCEPTED`；0.1.2 revision `140c311…` 的当前技术 Gate、持久运行和 YHBX 独立人工 UAT 均已通过。人工步骤为 YHBX 当前签署，不继承旧版本；production 与其余正式边界保持独立 |
